    ...
    public class clsResize
    {
        ...
        public void _resize() //Set the resize
        {
            ...
            foreach (Control control in _controls)
            {
                ...
                // (float)(((Convert.ToDouble(_fontsize) * _form_ratio_width) / 1.3) +
                //  ((Convert.ToDouble(_fontsize) * _form_ratio_height) / 1.3)));
            ...
            (float)(((Convert.ToDouble(_fontsize) * _form_ratio_width) / 1.5) +
             ((Convert.ToDouble(_fontsize) * _form_ratio_height) / 1.5)));
                ...
                //            control.Font = new System.Drawing.Font(form.Font.FontFamily, _fontsize);
                //    }
                //}
            }
        }
